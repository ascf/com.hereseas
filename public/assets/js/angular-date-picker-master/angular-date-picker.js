...
+ '        <div class="_day -padding" ng-repeat="day in leadingDays" data-month-offset="-1">.</div>'
+ '        <div class="_day" ng-repeat="day in days" ng-class="{ \'-selected\': (day === selectedDay), \'-today\': (day === today) }">{{ day }}</div>'
+ '        <div class="_day -padding" ng-repeat="day in trailingDays" data-month-offset="1">.</div>'
+ '    </div>'
+ '</div>'
        ;
